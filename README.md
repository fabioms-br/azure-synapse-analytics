...
## [2. Como ler dados em arquivo CSV no Azure Synapse Analytics](/synapse-analytics-ler-arquivo-csv.md)
...
## [3. Como fazer análise de Cotação do dolar no Azure Synapse Analytics](/azure-synapse-analisar-cotacao-dolar.md)
...
## [4. Como criar banco de dados SQL no Azure Synapse Analytics](/azure-synapse-analytics-criar-sql-database.md)
...
## [6. Como integrar o Power BI Serviço no Azure Synapse Analytics](/azure-synapse-analytics-integrar-power-bi.md)
Como integrar o Power BI Serviço no Azure Synapse Analytics utilizando a publicação de relatório dentro dessa estrutura
...
## [7. Como criar Lake Database no Azure Synapse Analytics](/azure-synapse-analytics-criar-lake-database.md)
...
## [10. Como fazer controle de versão no Azure Synapse Analytics](/azure-synapse-analytics-controle-versao.md)
Como habilitar o controle de versão dos objetos existentes do Azure Synapse Analytics associando ao repositório do Azure DevOps
